  ...
  return (
    <div className="flex flex-row py-0 px-4 items-center lg:items-stretch lg:px-2 lg:py-4 lg:flex-col lg:h-full">
      ...
      <div
        ...
        } bg-white absolute left-0 right-0 top-full shadow-md p-4 flex-col items-stretch
         text-[#5f5e5b] grow gap-2 lg:items-stretch lg:p-0 lg:bg-transparent lg:static lg:shadow-none lg:flex 
         lg:gap-0 lg:space-x-0 lg:space-y-2 lg:flex-col lg:justify-between`}
      >
        <NavLinks />
...
//         <form action={singOutOfAccount}>
//           <button
//             className="flex h-[48px] w-full items-center justify-start gap-2 shadow-custom rounded-md bg-white p-2 px-3 text-sm font-medium transition-colors text-[#050505] hover:hover:bg-[#00000008]"
//             type="submit"
//           >
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
