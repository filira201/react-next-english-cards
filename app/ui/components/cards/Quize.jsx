      ...
      {step !== data.length ? (
        ...
        <div className="flex flex-col justify-center items-center gap-10">
          ...
          <div className="w-full flex flex-col gap-4 sm:gap-0 sm:flex-row sm:justify-around">
            <button
              className="font-medium flex items-center justify-center rounded-lg bg-[#0582ff] text-white pt-[10px] px-5 pb-3 transition-colors hover:bg-[#045ac3] xm:min-w-48 "
              onClick={() => setStep(0)}
            >
              Пройти заново
            </button>
            <Link
              className="font-medium flex items-center justify-center rounded-lg bg-[#ebf5fe] text-[#087fe7] pt-[10px] px-5 pb-3 transition-colors hover:bg-[#d6e1f5] xm:min-w-48"
              href="/home/cards"
            >
